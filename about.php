        ...
        <body>
                ...
                <div class="menu">
                        ...
                        <p class="about" style="width: 1200px;">
                                ...
                                After the fourth script runs, the file will have a link generated to its location. If a client clicks this link,
                                the externalUser.php page uses the GET method to retrieve the file and then the PHP function readfile()
                                to download the file from /home/webUser to the client’s machine. Further details can be found at the GitHub link or at Learn More.
                         </p>
                     </div>
                 </div>
